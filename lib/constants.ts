...
export const FAQ_ITEMS = [
  {
    ...
    answer:
      "אנחנו להקה מקצועית שיוצרת חוויות משתפות. אצלנו הקהל הוא חלק בלתי נפרד מהמופע, ועולה איתנו לשיר, לנגן ולהיות רוקסטארס לערב אחד. הסל שלנו כולל מופעי 360 אינטימיים (Trio 360) שבהם הקהל עוטף אותנו ומוזמן להשתלב בשירה, מופעים חשמליים גדולים יותר (Your People On Stage) שבהם האנשים שלכם הם הכוכבים על הבמה, עם הכנה וליווי מקדים — כולל חזרה מקצועית — או ללא, תלוי בפורמט ובצורך שלכם. בנוסף, אנחנו עורכים סדנאות מוסיקה מעשיות לצוותים ומנהלים (Team Harmony). מחפשים פשוט הופעה מעולה? אנחנו מגיעים גם להופעות חיות קלאסיות, אנרגטיות וסוחפות שלנו, ללא שילוב קהל. אתם בוחרים את הפורמט שמתאים לכם.",
  },
  {
